...
const supplierSchema = z.object({
  ...
  payout_method: z.enum(["manual", "bank_transfer", "swift", "wise", "wise_transfer", "stripe_connect", "paypal_payout", "airwallex", "payoneer_payout"]).default("manual"),
  payout_currency: z.string().length(3).optional().default("USD"),
  payout_backup_method: z.enum(["manual", "bank_transfer", "swift", "wise", "wise_transfer", "stripe_connect", "paypal_payout", "airwallex", "payoneer_payout"]).optional().default("manual"),
